...
export default function Signup() {
    ...
    const signUp = async () => {
        const { error } = await supabase.auth.signUp({ email, password, options: { data: { name, handle } } });
        if (error) {
            console.error(error);
            window.alert(error);
        }
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input className="text-accent1 placeholder:text-accent1 pl-8"
                                        value={handle}
                            ...
                            <Button className="w-full bg-[#3bbf90cc] hover:bg-accent1" onClick={signUp}>
                                Sign Up
                            </Button>
                        </div>
                    </div>
