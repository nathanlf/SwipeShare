  ...
  useEffect(() => {
    async function fetchChat() {
      try {
        ...
        // Fetch chat data
        const chat = await getChatById(supabase, "5210cc44-9e27-451a-9867-9921a6ca6d13")
    ...
    <div className="p-8 mt-[-100px]">
      ...
      {chatData && (
        <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded">
          <p><strong>Chat ID:</strong> {chatData.id}</p>
          <p><strong>User 1:</strong> {chatData.user_1?.name || 'Unknown'}</p>
          <p><strong>User 2:</strong> {chatData.user_2?.name || 'Unknown'}</p>
