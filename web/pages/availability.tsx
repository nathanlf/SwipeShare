...
noonlist.push({ value: "12:00p", label: "12:00p" }, { value: "12:15p", label: "12:15p" }, { value: "12:30p", label: "12:30p" },
...
noonlist2.push({ value: "12:00p", label: "12:00p" }, { value: "12:15p", label: "12:15p" }, { value: "12:30p", label: "12:30p" },
    { value: "12:45p", label: "12:45p" }
)
            ...
            if (valueFrom != "" && valueTo != "") {
                ...
                if (str_timeto && str_timefrom) {
                    if (str_timeto <= str_timefrom) {
                        ...
                        setTimeslots((prev: Timeslot[]) => [...prev, { starttime: valueFrom, endtime: valueTo }])
                        setValueFrom("")
                        setValueTo("")
                    }
                }
        ...
        <div className="flex flex-col gap-y-10">
            <div className="flex flex-row items-center gap-x-16 mx-20 px-6 my-10 py-4 rounded-md text-center justify-center ">
                    ...
                    <Popover open={openFrom} onOpenChange={setOpenFrom}>
                        <PopoverTrigger asChild>
                            <Button
                                ...
                                className={valueFrom ? "w-[200px] justify-between font-semibold hover:bg-accent1-muted bg-[#3bbf9026] border-primary1 border-2 " :
                                        ...
                                        {timeslist.map((entry) => (
                                            <CommandItem
                                                ...
                                                onSelect={(currentValue) => {
                                                    setValueFrom(currentValue === valueFrom ? "" : currentValue)
                                                    setOpenFrom(false)
                                                }}
                                            >
                                                {entry.label}
                                                <Check
                                                    className={cn(
                                                        "ml-auto",
                                                        valueFrom === entry.value ? "opacity-100 " : "opacity-0"
                                                    )}
                                                />
                                            </CommandItem>
                                        ))}
                ...
                <div className="flex flex-row gap-x-4 items-center">
                    ...
                    <Popover open={openTo} onOpenChange={setOpenTo}>
                        <PopoverTrigger asChild>
                            <Button
                                ...
                                className={valueTo ? "w-[200px] justify-between font-semibold hover:bg-accent1-muted bg-[#3bbf9026] border-primary1 border-2 " :
                                    "w-[200px] justify-between font-semibold hover:bg-accent1-muted border-primary1 border-2"}
                            >
                                {valueTo
                                    ...
                                    <CommandGroup >
                                        {timeslist_to.map((entry) => (
                                            <CommandItem
                                                ...
                                                value={entry.value}
                                                onSelect={(currentValue) => {
                                                    setValueTo(currentValue === valueTo ? "" : currentValue)
                                                    setOpenTo(false)
                                                }}
                                            >
                                                {entry.label}
                                                <Check
                                                    className={cn(
                                                        "ml-auto",
                                                        valueTo === entry.value ? "opacity-100 " : "opacity-0"
                                                    )}
                                                />
                                            </CommandItem>
                                        ))}
                    ...
                    <Button onClick={() => { setButtonClicked(true); }}>add</Button>
                </div>
            </div>
