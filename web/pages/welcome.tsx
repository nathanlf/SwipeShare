      ...
      <div className="p-14 px-18 border border-b  bg-opacity-100 rounded-md shadow-lg">
        <div className="flex flex-row gap-x-6 justify-center items-center">
          <div className="flex flex-col gap-y-18">
            <p className="text-lg font-hubot">
              I am primarily interested in...
            </p>
            <p className="text-lg font-hubot">
              My day-to-day meal schedule is...
            </p>
          </div>
          <div className="flex flex-col gap-y-8 flex-grow">
            <ToggleGroup
              ...
              variant="outline"
              className="w-130"
              onValueChange={(value) => updatedonator(value)}
            >
              <ToggleGroupItem
                value="donating"
                aria-label="Toggle bold"
                className="font-bold font-hubot text-md p-8 shadow-sm"
              >
            ...
            <ToggleGroup
              ...
              variant="outline"
              className="w-130"
              onValueChange={(value) => updateflexible(value)}
            >
              <ToggleGroupItem
                value="flexible"
                aria-label="Toggle bold"
        ...
        <div className="flex flex-col mt-8 gap-y-10 items-center justify-center">
          <div className="flex flex-row gap-x-2 mt-10">
            <p>
              {" "}
              Don&apos;t worry, you can always change these preferences later.
            </p>
            <Soup />
          </div>
          <Button
